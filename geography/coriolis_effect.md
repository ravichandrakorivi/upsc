...
## 1. What is Coriolis Effect?

**Intuitive definition:**

The **Coriolis effect** is an apparent deflection of moving objects caused by the rotation of the Earth under them. 
...
## 2. Why do different parts of Earth move at different speeds?

The fundamental reason is that **different latitudes of Earth have different linear velocities due to Earth's rotation**.

Earth rotates once around its axis (from west to east direction) in approximately 24 hours.

Although the angular velocity of Earth's rotation is essentially the same at all latitudes, the linear velocity is not.
...
Consider an object moving from the North Pole towards the Equator.

At the North Pole:

- The object has almost no eastward linear velocity associated with Earth's rotation.
- As it moves towards the Equator, it enters regions where the Earth's surface has progressively greater eastward velocity.

The object does not immediately acquire the increasing eastward velocity of the surface beneath it.
...
Now consider an object moving from the Equator towards the North Pole.
